...
# 解压 (在项目根目录下运行)
7z x .\dist\mc-skin-wrap_0.0.3-rc.4+20260311_windows_amd64.zip -odist\
```
...
# 解压 (在项目根目录下运行)
7z x dist/mc-skin-wrap_0.0.3-rc.4+20260311_linux_amd64.tar.gz -odist/
7z x dist/mc-skin-wrap_0.0.3-rc.4+20260311_linux_amd64.tar -odist/ && rm dist/*.tar
```
